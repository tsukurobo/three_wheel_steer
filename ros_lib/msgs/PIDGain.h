#ifndef _ROS_msgs_PIDGain_h
#define _ROS_msgs_PIDGain_h
...
namespace msgs
{
  ...
  class PIDGain : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "msgs/PIDGain"; };
    virtual const char * getMD5() override { return "6920508e788c1527fe1a46709c00f235"; };
